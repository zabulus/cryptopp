...
#       else
#           define CRYPTOPP_WINRT_AVAILABLE
#       endif
#   else
#       define CRYPTOPP_WIN32_AVAILABLE
#   endif
...
#if defined(CRYPTOPP_WIN32_AVAILABLE) || defined(CRYPTOPP_UNIX_AVAILABLE) || defined(CRYPTOPP_WINRT_AVAILABLE)
...
#if defined(CRYPTOPP_WIN32_AVAILABLE) || defined(CRYPTOPP_WINRT_AVAILABLE)
...
#elif defined(HAS_BERKELEY_STYLE_SOCKETS)
#	define USE_BERKELEY_STYLE_SOCKETS
#endif

#if defined(HIGHRES_TIMER_AVAILABLE) && (defined(CRYPTOPP_WIN32_AVAILABLE) || defined(CRYPTOPP_WINRT_AVAILABLE)) && !defined(USE_BERKELEY_STYLE_SOCKETS)
#	define WINDOWS_PIPES_AVAILABLE
#endif

#if (defined(CRYPTOPP_WIN32_AVAILABLE) || defined(CRYPTOPP_WINRT_AVAILABLE)) && defined(USE_MS_CRYPTOAPI)
...
#if (defined(CRYPTOPP_WIN32_AVAILABLE) || defined(CRYPTOPP_WINRT_AVAILABLE)) && !defined(CRYPTOPP_DOXYGEN_PROCESSING)
