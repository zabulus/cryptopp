...
#if defined(CRYPTOPP_WIN32_AVAILABLE) || defined(CRYPTOPP_UNIX_AVAILABLE) || defined(CRYPTOPP_WIN_UWP_AVAILABLE)
...
#if defined(HIGHRES_TIMER_AVAILABLE) && (defined(CRYPTOPP_WIN32_AVAILABLE) || defined(CRYPTOPP_WIN_UWP_AVAILABLE)) && !defined(USE_BERKELEY_STYLE_SOCKETS)
...
#if (defined(CRYPTOPP_WIN32_AVAILABLE) || defined(CRYPTOPP_WIN_UWP_AVAILABLE)) && !defined(CRYPTOPP_DOXYGEN_PROCESSING)
